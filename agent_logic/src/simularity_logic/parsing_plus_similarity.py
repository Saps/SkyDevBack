...
from src.simularity_logic.deepseek_python_similarity_metrics import TextNormalizer, TextSimilarityCalculator
...
# folder_path = '\\data\input\\biznes-analitik\\biznes-analitik'
...
def get_similarity(folder_path, vacancy_txt_file):
