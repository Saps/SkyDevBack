"""
Django settings for skydev_drf project.
...
SECRET_KEY = 'django-insecure-07rfmtvg30isqo%)e@-p-6(gy)g1#%0i%@a+3agqw1aqtvt=uj'
...
WSGI_APPLICATION = 'skydev_drf.wsgi.application'
